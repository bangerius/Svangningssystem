...
Poler produceras där nämnarpolynomet har sina rötter. Vi har tre distinkt olika sätt som våra poler kan placera sig på enligt följande:

\begin{equation}
S_{rötter}=-\frac{c}{2m} \pm \sqrt{(\frac{c}{2m})^2-\frac{k}{m}}
\end{equation}

Vi ser att vi antingen kan få två komplexa rötter, en reell dubbelrot, eller två reella rötter.
S är en dubbelpol om $\sqrt{(\frac{c}{2m})^2-\frac{k}{m}}=0$
