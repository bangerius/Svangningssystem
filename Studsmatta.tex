...
Om man varierar de olika konstanterna så får man olika system med olika egenskaper. Vi gjorde några sådana tester med fas- och amplitudkaraktäristik, men inte med impuls- eller stegsvaret. Så här följer några olika variationer.

\begin{figure}[]
\begin{center}
\includegraphics[scale=0.3]{impulssvar(massa)}
\caption{Impulssvar med varierande massa}
\end{center}
\end{figure}
\begin{figure}[]
\begin{center}
\includegraphics[scale=0.3]{impulssvar(fjader)}
\caption{Impulssvar med varierande fjäderkonstant}
\end{center}
\end{figure}
\begin{figure}[]
\begin{center}
\includegraphics[scale=0.3]{impulssvar(dampning)}
...
\begin{figure}[]
\begin{center}
\includegraphics[scale=0.3]{stegsvar(massa)}
\caption{Stegsvar med varierande massa}
\end{center}
\end{figure}
\begin{figure}[]
\begin{center}
\includegraphics[scale=0.3]{stegsvar(fjader)}
\caption{Stegsvar med varierande fjäderkonstant}
\end{center}
\end{figure}
\begin{figure}[]
\begin{center}
\includegraphics[scale=0.3]{stegsvar(dampning)}
