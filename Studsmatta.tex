...
\begin{equation}
\int_{-\infty}^\tau \frac{1} {\omega_0 m} \cdot e^{-\alpha  t} \cdot sin(\omega_0  t) \cdot u(t) dt = \frac{1}{\omega_0  m} \int_{-\infty}^\tau sin(\omega_0 t)\cdot e^{-\alpha  t} \cdot u(t) dt
\end{equation}
...
= \int_{-\infty}^0 sin(\omega_0  t)\cdot e^{-\alpha  t} u(t) dt + \int_0^\tau sin(\omega_0  t)\cdot e^{-\alpha  t} \cdot u(t) dt $$
Eftersom $u(t)$ är 0 för negativa $t$ och 1 för positiva $t$ så kan vi skriva om integralen enligt nedan.
\begin{equation}
\int_{-\infty}^\tau sin(\omega_0  t)\cdot e^{-\alpha  t} u(t) dt
...
& = [-\frac{1}{\omega_0} cos(\omega_0 t) \cdot e^{-\alpha t}]_0^\tau - \int_0^\tau \frac{\alpha}{\omega_0} \cdot cos(\omega_0 t) \cdot e^{-\alpha t} dt \\
& = [-\frac{1}{\omega_0} cos(\omega_0 t) \cdot e^{-\alpha t}]_0^\tau - \\
& \frac{\alpha}{\omega_0} \cdot ([\frac{1}{\omega_0} sin(\omega_0 t) \cdot e^{-\alpha t}]_0^\tau - \int_0^\tau -\frac{\alpha}{\omega_0} \cdot sin(\omega_0  t)\cdot e^{-\alpha t} dt \\
\leftrightarrow
I & = [-\frac{1}{\omega_0} cos(\omega_0 t) \cdot e^{-\alpha t}]_0^\tau - \frac{\alpha}{\omega_0} \cdot ([\frac{1}{\omega_0} sin(\omega_0 t) \cdot e^{-\alpha t}]_0^\tau - (\frac{\alpha}{\omega_0})^2 I \\
...
\begin{equation}
g(\infty) = \frac{1 - cos(\omega_0 \infty) \cdot e^{-\alpha \infty}
- \frac{\alpha}{\omega_0^2} \cdot sin(\omega_0  \infty) \cdot e^{-\alpha  \infty}}{m  (\omega_o^2 +\alpha^2)}
\end{equation}

Vi kan se att $e^{-\alpha  \infty} = 0$ vilket ger

\begin{equation}
g(\infty) = \frac{1}{m  (\omega_o^2 +\alpha^2)}
\end{equation}
