...
Stabilitet med avseende på ett fysikaliskt system är att varje begränsad insignal ger en begränsad utsignal. Ett sätt att bevisa stabilitet är att visa att frekvensfunktionen $H(\omega)$ existerar. Vi har systemfunktionen $H(S)$ och kan därav bara kolla på noll-pol diagrammet om den reella axeln ($j\omega$-axeln) är med i konvergensområdet. Systemet är ett kausalt LTI system och därav kommer konvergensområdet ligga till höger om polerna enligt bild ((X)).
\begin{figure}[h]
\begin{center}
