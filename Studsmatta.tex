...
Fjäderkraften $F_f$ är den kraft som motverkar en fjäders avskiljning ifrån sitt jämviktsläge. Sambandet har namnet Hookes lag. Vi låter skillnaden från jämviktsläget vara $y$, och fjäderkonstanten $k$. Denna kraft är motriktad den av gravitationen. 
((Tror detta ska vara rätt, bör kollas över))
\begin{equation}
F_f = -k \cdot y
\end{equation}
...
\begin{equation}
F_{tot} = x(t) + mg - ky - cv = ma
\end{equation}
((MÅSTE KOLLAS ÖVER!!! TODO: LOTS))
...
\begin{equation}
m\frac{d^2y_1(t)}{dt^2} + cm\frac{dy_1(t)}{dt} + ky_1(t) = x_1(t)
\end{equation}

\begin{equation}
m\frac{d^2y_2(t)}{dt^2} + cm\frac{dy_2(t)}{dt} + ky_2(t) = x_2(t)
\end{equation}
...
\begin{equation}
m\frac{d^2\{a_1y_1(t) + a_2y_2(t)\}}{dt^2} + cm\frac{d\{a_1y_1(t) + a_2y_2(t)\}}{dt} + k\{a_1y_1(t) + a_2y_2(t)\}
\end{equation}

Vilket ger:
\begin{multline}
m\frac{d^2y(t)}{dt^2} + cm\frac{dy(t)}{dt} + ky(t) = \\ m\frac{d^2\{a_1y_1(t) + a_2y_2(t)\}}{dt^2} + cm\frac{d\{a_1y_1(t) + a_2y_2(t)\}}{dt} + k\{a_1y_1(t) + a_2y_2(t)\}
\end{multline}
