...
Vilket enligt våra tidigare definitioner och Newtons lag ger:
...
\begin{equation}
 m\frac{d^2y(t)}{dt^2} =  -k(l_0 + y(t)) -cm\frac{dy(t)}{dt} + mg +  x(t)
\end{equation}
...
\begin{equation}
 m\frac{d^2y(t)}{dt^2} + k \cdot y(t)) + cm\frac{dy(t)}{dt} = x(t)
\end{equation}
